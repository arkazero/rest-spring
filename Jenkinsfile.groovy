...
node{
	...
	try {
		...
		stage('Checkout'){
			...
			git credentialsId: 'githubWilmer', url: 'https://github.com/wwilmeraguilera/rest-spring.git'
...
//		}
        ...
        emailext(mimeType: 'text/html', replyTo: 'waguiler@redhat.com', subject: statusProcess+" : " + env.JOB_NAME, to: 'waguiler@redhat.com', body: statusProcess + " : " + env.JOB_NAME+ " : "+errorMessage)
